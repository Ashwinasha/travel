    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-12 col-11">
                <div class="newsletter-card p-2 p-md-4 bg-white rounded-4" style="position: relative;">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-md-4 d-none d-md-flex">
                            <img src="img/bird.jpg" alt="Newsletter bird" class="img-fluid">
                        </div>
                        <div class="col-lg-8 col-md-8">
                            <div class="px-2 px-md-5"> <!-- Adjusted padding here -->
                                <h6 class="text-primary mb-2 fs-6 fs-md-5 text-decoration-underline text-center text-md-start">Newsletters</h6>
                                <h2 class="newsletter-title text-danger fw-bold mb-3 fs-4 fs-md-2 text-center text-md-start">Get Our Every Single Notification</h2>

                                <!-- Form layout adjustments -->
                                <form class="row g-2 align-items-center">
                                    <div class="col-8 col-md-8">
                                        <input type="email" class="form-control text-center text-md-start clr" placeholder="Enter your email here">
                                    </div>
                                    <div class="col-4 col-md-4">
                                        <button type="submit" class="btn bg-danger fs-6 fs-md-5 text-white w-100">Subscribe</button>
                                    </div>
                                </form>
...
<!-- Footer -->
<footer class="footer-content shadow pt-3 " style="background-color: white; z-index: 1;">
    <div class="bg-white mt-5">
        <div class="container text-center">
            <div class="row align-items-center mb-0 mb-md-2 mb-lg-2">
                <div class="col-md-6 col-lg-4 text-white mt-5">
            ...
            <section class="pb-3 pt-0 border-danger border-top border-3">
                <div class="row d-flex align-items-center">
                    <div class="col-md-8 col-lg-6 text-lg-start text-md-start text-sm-center">
                        <div class="py-3 text-dark">
                            Copyright ©️ 2024 All rights reserved by:
                            <a class="text-decoration-none text-dark" href="">Hale Cinnamon</a>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-6 text-lg-end text-sm-center">
                        <div class="py-3 text-dark">
                            Web Developed by
                            <a class="text-decoration-none text-dark" href="https://www.apexx.lk/">Apexx Private Limited</a>
                        </div>
                    </div>
                </div>
            </section>
